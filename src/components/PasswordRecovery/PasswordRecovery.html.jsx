// PasswordRecoveryHTML.js handles the presentation of the password recovery page, including the form and success modal.
                    ...
                    <div className="fixed inset-0 bg-gray-600 bg-opacity-50 flex justify-center items-center">
                        <div className="relative top-20 mx-auto p-5 border w-96 shadow-lg rounded-md bg-white">
                            <div className="mt-3 text-center">
                                <p className="text-lg leading-6 font-medium text-gray-900">Password Successfully Updated</p>
                                <div className="mt-4">
                                    <button
                                        onClick={() => {
                                            if (isLoggedIn) {
                                        ...
                                        className="inline-flex justify-center w-full rounded-md border border-transparent shadow-sm px-4 py-2 bg-blue-500 text-base font-medium text-white hover:bg-blue-700 focus:outline-none sm:mt-0 sm:ml-3 sm:w-auto sm:text-sm"
                                    >
                                        OK
                                    </button>
                                </div>
...
export default PasswordRecoveryHTML;
