        ...
        return (
            <>
                <div className="inset-0 mx-auto container bg-slate-100 flex flex-col gap-8 rounded-2xl w-1/3 h-80 justify-center items-center p-12">
                    <form onSubmit={activeTab === 'login' ? handleLoginSubmit : handleRegisterSubmit} className="flex flex-col items-center gap-2">
                        <div className="flex flex-col items-center gap-2">
                            ...
                            <div>
                                ...
                                <input type="password" id="password" name="password" value={formData.password} onChange={handleInputChange} className="mt-1 block w-80 rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm h-8 pl-2" />
                            ...
                            <p id="switch-auth" class="text-center text-blue-600 mt-0 cursor-pointer">
                                ...
                                {activeTab === 'login' ? "Don't have an account? Register here" : 'Already have an account? Login here'}
                            </p>
                        </div>
                    </form>
