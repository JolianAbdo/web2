...
<div class="bg-gray-100 font-sans">
  ...
  <div class="container mx-auto mt-8 flex flex-col md:flex-row">
    <div class="flex-auto w-full md:w-1/2 md:mr-8 mb-8 md:mb-0 bg-white shadow-lg rounded-lg">
    ...
    {/* Event Creation Form */}
    <div class="flex-auto w-full md:w-1/2 bg-white p-8 rounded-lg shadow-md">
